...
- QR issue, full scanned-token payload proof validation, tampered/incomplete QR rejection, replay rejection, no-user-id QR payload, daily cap rejection, and aggregate analytics all work.
